...
First-Come, First-Served (FCFS) Shortest Job First (SJF) Priority Scheduling Round Robin (RR) Multilevel Queue Multilevel Feedback Queue

Detailed metrics for algorithm comparison:

Average waiting time Average turnaround time CPU utilization Throughput
